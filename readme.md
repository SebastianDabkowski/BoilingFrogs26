...
[Zapisz się na warsztat](https://architectural-kata.konfeo.com/)

Więcej informacji znajdziesz też tutaj:

[arpeggia.studio/kata](https://arpeggia.studio/kata)
...
**20% zniżki tylko do poniedziałku**

Na warsztacie pracujemy praktycznie nad:

- Event Storming
- modelem C4
- analizą trade offów
- wykorzystaniem AI w pracy architekta
